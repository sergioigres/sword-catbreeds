...
import com.swordcatbreedsapplication.data.dummy.toDomain

/**
 * SampleData for Jetpack Compose Tutorial
 */
object DummyLocalData {
    // Sample conversation data

    fun List<DummyCatBreed>.toDomainList(): List<CatBreed> {
        return this.map { it.toDomain() }
    }

    val listOfCatBreeds = listOf(
        DummyCatBreed(
        ...
        DummyCatBreed(
            ...
            "Abyssinian",
            "Egypt",
            "Native to the Greek islands",
            "Active, Energetic, Independent, Intelligent, Gentle".trim()
        ),
        DummyCatBreed(
            "https://media.istockphoto.com/id/1443562748/photo/cute-ginger-cat.jpg?s=612x612&w=0&k=20&c=vvM97wWz-hMj7DLzfpYRmY2VswTqcFEKkC437hxm3Cg=",
            "Abyssinian",
